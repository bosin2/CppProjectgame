...
void showExplan() {
    ...
    cout << "   [ 원소별 획득 능력치 ]\n";
    cout << "   - 불   : 공격력 +5 / 최대 체력 +10 / 현재 체력 +10\n";
    cout << "   - 물   : 흡혈율 +5% / 최대 체력 +5 / 현재 체력 +5\n";
    cout << "   - 흙   : 방어력 +2 / 최대 체력 +15 / 현재 체력 +15\n";
    cout << "   - 바람 : 회피율 +10% / 최대 체력 +5 / 현재 체력 +5\n\n";
    cout << "   - 같은 원소를 중복해서 획득하면 기술이 강화됩니다.\n\n";

    cout << "   [ 속성 상성 관계 ]\n";
    cout << "   - 유리한 상성 (피해 2배)   : 불 -> 흙 -> 바람 -> 물 -> 불\n";
    cout << "   - 불리한 상성 (피해 0.5배) : 흙 -> 불 -> 물 -> 바람 -> 흙\n\n";

    cout << "   [ 조합 공격 레시피 ]\n";
    cout << "   (서로 다른 원소를 획득하면 조합 공격 해금!)\n\n";
    cout << "   (조합 공격은 두 원소의 데미지의 합보다 강력합니다!)\n\n";
    cout << "   - 불 + 물   : 증기 폭발\n";
    cout << "   - 불 + 흙   : 용암 투척\n";
    cout << "   - 불 + 바람 : 화염 돌풍\n";
    cout << "   - 물 + 흙   : 진흙 늪\n";
